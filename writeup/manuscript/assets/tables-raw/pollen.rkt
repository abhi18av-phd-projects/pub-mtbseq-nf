...
;; Helper functions for conditional content that return proper strings
...
(define (typst-table-wrapper content)
  (when-typst
    (string-append "#three-line-table[\n" content "]\n")))

(define (markdown-table-wrapper content)
  (when-docx content))
...
;; Complete table rendering function
...
;; Override the root function to avoid wrapper parentheses
(define (root . elements)
  (apply string-append (map ~a elements)))
